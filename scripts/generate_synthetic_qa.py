...
registros se escriben en el formato messages (SFT-ready) que espera Unsloth
o HuggingFace TRL.
...
Flujo:
  ...
  5. Escribe dos archivos:
       ...
       - synthetic_qa_sft.jsonl  → formato {"messages": [...], "metadata": {...}}
                                   listo para ser pasado a split_dataset.py
